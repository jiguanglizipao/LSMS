...
class TestTestCase(TestCase):
	def setUp(self):
		...
		computing2 = {'pc_type': 'p', 'cpu': 'core', 'memory': 1024,
					  'disk': 100, 'disk_type': 's', 'os': 'linux',
					  'expire_time': date.today() + timedelta(days=5),
					  'login': 'yurong', 'password': 'yurong',
					  'status': 'vf', 'account': Account.objects.get(id=1),
					  'note': "what the hell", 'address': '127.0.0.2', 'flag': False,
					  'name': 'comp2', 'pack_name': 'pack2'}
	...
	def test_update_success(self):
		update_content = {'pc_type': 'v', 'cpu': 'Xeon', 'memory': 1023,
						  'disk': 101, 'disk_type': 'm', 'os': 'mac os',
						  'sn': 'c2', 'expire_time': date(2015, 12, 3),
						  'login': 'rongyuMo', 'password': 'rongyuMo',
						  'status': 'ri', 'note': "hello world",
						  'address': '127.0.0.9', 'flag': False}
	...
	def test_package_update_success(self):
		update_content = {'name': 'pp1', 'cpu': 'xeon',
						  'pc_type': 'v', 'memory': 2048,
						  'disk': 2048, 'disk_type': 'm', 'os': 'mac os'}
